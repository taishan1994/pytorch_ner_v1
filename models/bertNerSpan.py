...
class BertNerSpanModel(BaseModel):
    def __init__(self,
                 bert_dir,
                 num_tags,
                 dropout_prob=0.1,
        ...
        """
        super(BertNerSpanModel, self).__init__(bert_dir, dropout_prob=dropout_prob)
    ...
    def forward(self,
        ...
        start_logits = self.start_fc(seq_out)  # [12,256,13]
        end_logits = self.end_fc(seq_out)  # [12,256,13]
    ...
    def loss(self, start_ids, end_ids, start_logits, end_logits, attention_masks):
        # padding 部分的标签，计算真实 loss
        # attention_masks:[12,256]
