...
preprocess("demo.train.char", '../mid_data', "train")
preprocess("demo.dev.char", '../mid_data', "dev")
preprocess("demo.test.char", '../mid_data', "test")
...
if not os.path.exists(path):
    os.makedirs(path)
with open(os.path.join(path, "ent2id.json"),'w') as fp:
